package com.serveme.service.order.util.api;

import com.serveme.service.order.util.api.error.ApiError;
import com.serveme.service.order.util.api.httpExceptions.*;
import com.serveme.service.order.util.validation.exception.ValidatorGenericException;
