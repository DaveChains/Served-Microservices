package com.millennialslab.served.service.util.validation;



import com.millennialslab.served.service.util.validation.exception.*;
...
public class SimpleValidator {
    ...
    private void checkEmails() throws NoSuchFieldException, IllegalAccessException{
        ...
        try{
            ...
            for(String emailFieldName:emailList){
                lastFieldName = emailFieldName;
                Field field = clazz.getDeclaredField(emailFieldName);
                field.setAccessible(true);
                Object object = field.get(obj);
                if( object instanceof String && ( object != null)){
                    lastEmailValue = (String)object;
                    new InternetAddress(lastEmailValue).validate();
                }
            }
        }catch(AddressException ex){
            throw new ValidatorEmailException(lastFieldName, lastEmailValue);
